...
import os
import math
from torch.nn import Linear, BatchNorm1d, Conv2d, Sequential, ReLU, Softmax
...
class MT_GAT_topk_shareEn_multiple8_joint_last(torch.nn.Module):
    ...
    def forward(self, x, edge_index, edge_weight, batch, device):
        ...
        torch.sigmoid(score7), x8, perm8, torch.sigmoid(score8), att#, x111, x222, edge_sz, weight_sz, edge_cog, weight_cog
